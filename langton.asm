...
; *********************************************************************************************
                ...
                JPS _Print "Langton's Ant (esc to quit)", 0     ; print the title
...
pause:          JAS _ReadInput                                  ;
                CPI 0x1b                                        ; escape to exit even from pause
                BEQ exit                                        ;
                CPI 'p'                                         ; p to resume from pause
                BNE pause                                       ;
                JPA resume                                      ;
